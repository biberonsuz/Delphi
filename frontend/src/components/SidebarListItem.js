const SidebarListItem = ({ icon: Icon, label, href, isSelected, size = 20, strokeWidth = 1.5, onClick }) => {
  return (
    <li>
      <a 
        href={href} 
        ...
        <span className={`py-2 px-2 rounded-3xl ${isSelected ? 'bg-gray-200' : 'bg-gray-200'}`}>
